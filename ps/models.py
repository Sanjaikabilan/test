...
class State(models.Model):
    ...
    doms = (('Energy Engineering','Energy Engineering'),('Electrical and Electronics Engineering','Electrical and Electronics Engineering'),('Textile and Fashion Technology','Textile and Fashion Technology'),('Robotics and Autonomous Systems','Robotics and Autonomous Systems'), ('Sustainable Technology', 'Sustainable Technology'))
    ...
    domain = models.CharField(choices=doms, max_length=100, null=True, blank=True)
    hardness = models.CharField(choices = level,max_length=25, null=True, blank=True)
    contact = models.CharField(choices=contax, max_length=100, null=True, blank=True)
    contact_person = models.CharField(choices=cp, max_length=100, null=True, blank=True)
